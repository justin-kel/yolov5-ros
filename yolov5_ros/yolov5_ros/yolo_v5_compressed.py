...
class yolov5_ros(Node):
    def __init__(self):
        ...
        self.pub_image = self.create_publisher(CompressedImage, 'yolov5/image_raw', 10)

        self.sub_image = self.create_subscription(CompressedImage, 'camera/image/compressed', self.image_callback, qos_profile)
    ...
    def image_callback(self, image:CompressedImage):
        ...
        image_raw = self.bridge.compressed_imgmsg_to_cv2(image, "bgr8")
